...
> 在这个 GitHub Profile 仓库中安装 RepoPalette。按照 https://github.com/onovich/RepoPalette/blob/da7a7a7ad5ad0e64662fa9bb96d9ad9a0940102e/docs/INSTALL_WITH_AI.md 操作，使用默认设置，并验证第一次自动运行。
