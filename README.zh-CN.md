...
> 在这个 GitHub Profile 仓库中安装 RepoPalette。按照 https://github.com/onovich/RepoPalette/blob/dd3079df35c53ad325b1560a387b4457846af88b/docs/INSTALL_WITH_AI.md 操作，使用默认设置，并验证第一次自动运行。
